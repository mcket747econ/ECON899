...
function Initialize()  ##Instantiate initial values for relevant variables
    ...
    welf = 0.0
    CV = 0.0
    res = Results(pol_func,val_func, lab_func,age_j, r,w,b,F, K, L,welf,CV)         ##Note - added CV and welfare to results
    prim, res
end
...
Plots.savefig("PS_03_valfunc_50.png")
...
Plots.savefig("PS_03_savefunc_20.png")
...
Plots.savefig("PS_03_fdist_1.png")
...
Plots.savefig("PS_03_fdist_50.png")
...
### Trying code for the welfare function 
